        ...
        <>
            ...
            <form action="" className='flex flex-col gap-6 px-10 py-8'>
                <div className="flex w-full">
                    <h1 className='flex text-2xl font-bold'>Sign Up</h1>
                </div>
                <div className="flex w-full ">
                ...
                <div className="flex w-full">
                    <button className='flex w-full text-white  rounded-md py-2 px-3 items-center justify-center btn-color'>Sign Up</button>
                </div>
                <div className="grid grid-cols-2 w-full">
                    <div className="flex w-full text-xs">
                        <p className='flex text-gray-500'>Already have an account?</p>
                        <button className='flex text-brandColor underline'>Sign In</button>
                    </div>
